...
def main() -> int:
    ...
    payload = {
        ...
        "runtime_metrics": {
            ...
            "overlay_snapshot_lock_ms": metrics.get("overlay_snapshot_lock_ms"),
            "mask_prepare_ms": metrics.get("mask_prepare_ms"),
            "mask_rasterize_ms": metrics.get("mask_rasterize_ms"),
            "frame_composite_ms": metrics.get("frame_composite_ms"),
            "annotation_draw_ms": metrics.get("annotation_draw_ms"),
            "overlay_total_ms": metrics.get("overlay_total_ms"),
            "cached_jpeg_age_seconds": metrics.get("cached_jpeg_age_seconds"),
            "jpeg_encode_ms": metrics.get("jpeg_encode_ms"),
            "request_handler_ms": metrics.get("request_handler_ms"),
